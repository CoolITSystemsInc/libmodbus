...
MODBUS_API int modbus_proxy(modbus_t* master_ctx, modbus_t* slave_ctx, uint8_t* master_req,
		int master_req_length);

MODBUS_API int modbus_receive_raw_confirmation(modbus_t *ctx, uint8_t *rsp);
/**
 * UTILS FUNCTIONS
 **/
